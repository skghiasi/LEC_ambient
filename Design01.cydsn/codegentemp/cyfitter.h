...
#define Pin_Vin__0__DM__SHIFT 12u
...
/* Clk_Timer */
#define Clk_Timer__DIVIDER_MASK 0x0000FFFFu
#define Clk_Timer__ENABLE CYREG_CLK_DIVIDER_A01
#define Clk_Timer__ENABLE_MASK 0x80000000u
#define Clk_Timer__MASK 0x80000000u
#define Clk_Timer__REGISTER CYREG_CLK_DIVIDER_A01
#define Clk_Timer_1__DIVIDER_MASK 0x0000FFFFu
#define Clk_Timer_1__ENABLE CYREG_CLK_DIVIDER_B01
#define Clk_Timer_1__ENABLE_MASK 0x80000000u
#define Clk_Timer_1__MASK 0x80000000u
#define Clk_Timer_1__REGISTER CYREG_CLK_DIVIDER_B01

/* pin_incl_x */
#define pin_incl_x__0__DM__MASK 0xE00u
#define pin_incl_x__0__DM__SHIFT 9u
#define pin_incl_x__0__DR CYREG_PRT0_DR
#define pin_incl_x__0__HSIOM CYREG_HSIOM_PORT_SEL0
#define pin_incl_x__0__HSIOM_MASK 0x0000F000u
#define pin_incl_x__0__HSIOM_SHIFT 12u
#define pin_incl_x__0__INTCFG CYREG_PRT0_INTCFG
#define pin_incl_x__0__INTSTAT CYREG_PRT0_INTSTAT
#define pin_incl_x__0__MASK 0x08u
#define pin_incl_x__0__OUT_SEL CYREG_UDB_PA0_CFG10
#define pin_incl_x__0__OUT_SEL_SHIFT 6u
#define pin_incl_x__0__OUT_SEL_VAL 1u
#define pin_incl_x__0__PA__CFG0 CYREG_UDB_PA0_CFG0
#define pin_incl_x__0__PA__CFG1 CYREG_UDB_PA0_CFG1
#define pin_incl_x__0__PA__CFG10 CYREG_UDB_PA0_CFG10
#define pin_incl_x__0__PA__CFG11 CYREG_UDB_PA0_CFG11
#define pin_incl_x__0__PA__CFG12 CYREG_UDB_PA0_CFG12
#define pin_incl_x__0__PA__CFG13 CYREG_UDB_PA0_CFG13
#define pin_incl_x__0__PA__CFG14 CYREG_UDB_PA0_CFG14
#define pin_incl_x__0__PA__CFG2 CYREG_UDB_PA0_CFG2
#define pin_incl_x__0__PA__CFG3 CYREG_UDB_PA0_CFG3
#define pin_incl_x__0__PA__CFG4 CYREG_UDB_PA0_CFG4
#define pin_incl_x__0__PA__CFG5 CYREG_UDB_PA0_CFG5
#define pin_incl_x__0__PA__CFG6 CYREG_UDB_PA0_CFG6
#define pin_incl_x__0__PA__CFG7 CYREG_UDB_PA0_CFG7
#define pin_incl_x__0__PA__CFG8 CYREG_UDB_PA0_CFG8
#define pin_incl_x__0__PA__CFG9 CYREG_UDB_PA0_CFG9
#define pin_incl_x__0__PC CYREG_PRT0_PC
#define pin_incl_x__0__PC2 CYREG_PRT0_PC2
#define pin_incl_x__0__PORT 0u
#define pin_incl_x__0__PS CYREG_PRT0_PS
#define pin_incl_x__0__SHIFT 3u
#define pin_incl_x__DR CYREG_PRT0_DR
#define pin_incl_x__INTCFG CYREG_PRT0_INTCFG
#define pin_incl_x__INTSTAT CYREG_PRT0_INTSTAT
#define pin_incl_x__MASK 0x08u
#define pin_incl_x__PA__CFG0 CYREG_UDB_PA0_CFG0
#define pin_incl_x__PA__CFG1 CYREG_UDB_PA0_CFG1
#define pin_incl_x__PA__CFG10 CYREG_UDB_PA0_CFG10
#define pin_incl_x__PA__CFG11 CYREG_UDB_PA0_CFG11
#define pin_incl_x__PA__CFG12 CYREG_UDB_PA0_CFG12
#define pin_incl_x__PA__CFG13 CYREG_UDB_PA0_CFG13
#define pin_incl_x__PA__CFG14 CYREG_UDB_PA0_CFG14
#define pin_incl_x__PA__CFG2 CYREG_UDB_PA0_CFG2
#define pin_incl_x__PA__CFG3 CYREG_UDB_PA0_CFG3
#define pin_incl_x__PA__CFG4 CYREG_UDB_PA0_CFG4
#define pin_incl_x__PA__CFG5 CYREG_UDB_PA0_CFG5
#define pin_incl_x__PA__CFG6 CYREG_UDB_PA0_CFG6
#define pin_incl_x__PA__CFG7 CYREG_UDB_PA0_CFG7
#define pin_incl_x__PA__CFG8 CYREG_UDB_PA0_CFG8
#define pin_incl_x__PA__CFG9 CYREG_UDB_PA0_CFG9
#define pin_incl_x__PC CYREG_PRT0_PC
#define pin_incl_x__PC2 CYREG_PRT0_PC2
#define pin_incl_x__PORT 0u
#define pin_incl_x__PS CYREG_PRT0_PS
#define pin_incl_x__SHIFT 3u
...
/* HumidityTempIsr */
#define HumidityTempIsr__INTC_CLR_EN_REG CYREG_CM0_ICER
#define HumidityTempIsr__INTC_CLR_PD_REG CYREG_CM0_ICPR
#define HumidityTempIsr__INTC_MASK 0x10000u
#define HumidityTempIsr__INTC_NUMBER 16u
#define HumidityTempIsr__INTC_PRIOR_MASK 0xC0u
#define HumidityTempIsr__INTC_PRIOR_NUM 3u
#define HumidityTempIsr__INTC_PRIOR_REG CYREG_CM0_IPR4
#define HumidityTempIsr__INTC_SET_EN_REG CYREG_CM0_ISER
#define HumidityTempIsr__INTC_SET_PD_REG CYREG_CM0_ISPR

/* TimerHumidityTemp */
#define TimerHumidityTemp_cy_m0s8_tcpwm_1__CC CYREG_TCPWM_CNT0_CC
#define TimerHumidityTemp_cy_m0s8_tcpwm_1__CC_BUFF CYREG_TCPWM_CNT0_CC_BUFF
#define TimerHumidityTemp_cy_m0s8_tcpwm_1__COUNTER CYREG_TCPWM_CNT0_COUNTER
#define TimerHumidityTemp_cy_m0s8_tcpwm_1__CTRL CYREG_TCPWM_CNT0_CTRL
#define TimerHumidityTemp_cy_m0s8_tcpwm_1__INTR CYREG_TCPWM_CNT0_INTR
#define TimerHumidityTemp_cy_m0s8_tcpwm_1__INTR_MASK CYREG_TCPWM_CNT0_INTR_MASK
#define TimerHumidityTemp_cy_m0s8_tcpwm_1__INTR_MASKED CYREG_TCPWM_CNT0_INTR_MASKED
#define TimerHumidityTemp_cy_m0s8_tcpwm_1__INTR_SET CYREG_TCPWM_CNT0_INTR_SET
#define TimerHumidityTemp_cy_m0s8_tcpwm_1__PERIOD CYREG_TCPWM_CNT0_PERIOD
#define TimerHumidityTemp_cy_m0s8_tcpwm_1__PERIOD_BUFF CYREG_TCPWM_CNT0_PERIOD_BUFF
#define TimerHumidityTemp_cy_m0s8_tcpwm_1__STATUS CYREG_TCPWM_CNT0_STATUS
#define TimerHumidityTemp_cy_m0s8_tcpwm_1__TCPWM_CMD CYREG_TCPWM_CMD
#define TimerHumidityTemp_cy_m0s8_tcpwm_1__TCPWM_CMDCAPTURE_MASK 0x01u
#define TimerHumidityTemp_cy_m0s8_tcpwm_1__TCPWM_CMDCAPTURE_SHIFT 0u
#define TimerHumidityTemp_cy_m0s8_tcpwm_1__TCPWM_CMDRELOAD_MASK 0x100u
#define TimerHumidityTemp_cy_m0s8_tcpwm_1__TCPWM_CMDRELOAD_SHIFT 8u
#define TimerHumidityTemp_cy_m0s8_tcpwm_1__TCPWM_CMDSTART_MASK 0x1000000u
#define TimerHumidityTemp_cy_m0s8_tcpwm_1__TCPWM_CMDSTART_SHIFT 24u
#define TimerHumidityTemp_cy_m0s8_tcpwm_1__TCPWM_CMDSTOP_MASK 0x10000u
#define TimerHumidityTemp_cy_m0s8_tcpwm_1__TCPWM_CMDSTOP_SHIFT 16u
#define TimerHumidityTemp_cy_m0s8_tcpwm_1__TCPWM_CTRL CYREG_TCPWM_CTRL
#define TimerHumidityTemp_cy_m0s8_tcpwm_1__TCPWM_CTRL_MASK 0x01u
#define TimerHumidityTemp_cy_m0s8_tcpwm_1__TCPWM_CTRL_SHIFT 0u
#define TimerHumidityTemp_cy_m0s8_tcpwm_1__TCPWM_INTR_CAUSE CYREG_TCPWM_INTR_CAUSE
#define TimerHumidityTemp_cy_m0s8_tcpwm_1__TCPWM_INTR_CAUSE_MASK 0x01u
#define TimerHumidityTemp_cy_m0s8_tcpwm_1__TCPWM_INTR_CAUSE_SHIFT 0u
#define TimerHumidityTemp_cy_m0s8_tcpwm_1__TCPWM_NUMBER 0u
#define TimerHumidityTemp_cy_m0s8_tcpwm_1__TR_CTRL0 CYREG_TCPWM_CNT0_TR_CTRL0
#define TimerHumidityTemp_cy_m0s8_tcpwm_1__TR_CTRL1 CYREG_TCPWM_CNT0_TR_CTRL1
#define TimerHumidityTemp_cy_m0s8_tcpwm_1__TR_CTRL2 CYREG_TCPWM_CNT0_TR_CTRL2
