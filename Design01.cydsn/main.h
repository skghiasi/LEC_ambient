...
#define RECEIVE_BUFFER_SIZE        (3u)
#define RECEIVE_PACKET_SIZE (RECEIVE_BUFFER_SIZE)
...
#define eRHumidityCmd   (0xE5)
#define eTempNoHoldCmd  (0xF3)
#define eRHumidityHoldCmd (0xF5)

/* Delay between commands in milliseconds */
#define CMD_TO_CMD_DELAY    (500u)

/* Max rpm of the turbine */
#define MAX_TURBINE_RPM 80
